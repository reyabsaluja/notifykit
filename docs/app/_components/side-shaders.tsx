...
export function SideShaders() {
  return (
    <div className="side-shaders" aria-hidden="true">
      <div className="side-shader side-shader-1">
        <ShaderLabComposition config={config} />
      </div>
      <div className="side-shader side-shader-2">
        <ShaderLabComposition config={config} />
      </div>
      <div className="side-shader side-shader-3">
        <ShaderLabComposition config={config} />
      </div>
      <div className="side-shader side-shader-4">
        <ShaderLabComposition config={config} />
      </div>
      <div className="side-shader side-shader-5">
        <ShaderLabComposition config={config} />
      </div>
      <div className="side-shader side-shader-6">
        <ShaderLabComposition config={config} />
      </div>
      <div className="side-shader side-shader-7">
        <ShaderLabComposition config={config} />
      </div>
      <div className="side-shader side-shader-8">
        <ShaderLabComposition config={config} />
      </div>
    </div>
  );
